...
class ItemImageUploadPage extends StatefulWidget {
  final CompressDto compressDto;
  final ImageSource retry;

  const ItemImageUploadPage({super.key, required this.compressDto, required this.retry});

  @override
  State<ItemImageUploadPage> createState() => _ItemImageUploadPageState();
}

class _ItemImageUploadPageState extends State<ItemImageUploadPage> {
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              if (_isBackgroundRemove) {
                                Navigator.pop(
                                  context,
                                  {"itemImage": _removeImage, "itemThumbnail": _removeThumbnail},
                                );
                              } else {
                                Navigator.pop(context, {
                                  "itemImage": File(widget.compressDto.image),
                                  "itemThumbnail": File(widget.compressDto.thumbnail),
                                });
                              }
                            },
                            child: Container(
