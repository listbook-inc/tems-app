...
class DeleteItemDialog extends StatefulWidget {
  ...
  const DeleteItemDialog({super.key, required this.onSuccess});
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  Translations.of(context)?.trans("delete_item_alert_message") ??
                      "If you delete the item, it cannot be restored, will you proceed?",
